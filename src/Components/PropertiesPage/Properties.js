...
const Properties = () => {
    ...
    const filteredProperties = properties.filter((property) => {
        ...
        const matchesPostalCode = searchPostalCode ? property.postalCode.toLowerCase().includes(searchPostalCode.toLowerCase()): true;
        const matchesDate = !searchDate || (property.added && new Date(
            property.added.year,
